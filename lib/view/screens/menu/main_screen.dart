...
import 'package:zabayeh_aljazeera/view/base/third_party_chat_widget.dart';
...
import 'package:zabayeh_aljazeera/view/screens/home/home_screens.dart';
import 'package:zabayeh_aljazeera/view/screens/html/html_viewer_screen.dart';
import 'package:zabayeh_aljazeera/view/screens/menu/widget/custom_drawer.dart';
                ...
                builder: (context, locationProvider, child) => Scaffold(
                  ...
                  appBar: ResponsiveHelper.isDesktop(context) ? null : AppBar(
                    ...
                    title: splash.pageIndex == 0 ? Row(children: [
                      Image.asset(Images.app_logo_bar, width: 35),
                      SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                      Expanded(child: Text(
                        AppConstants.APP_NAME_BAR, maxLines: 1, overflow: TextOverflow.ellipsis,
