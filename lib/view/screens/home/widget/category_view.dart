...
import 'package:zabayeh_aljazeera/view/screens/home/web/web_categories.dart';
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: index != 9 ? ClipRRect(
                            ...
                            alignment: Alignment.center,
                            child: Text('${category.categoryList.length - 9}+', style: poppinsRegular.copyWith(color: Theme.of(context).cardColor)),
                          ),
                        ),
                      ),
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            index != 9 ? category.categoryList[index].name : getTranslated('view_all', context),
