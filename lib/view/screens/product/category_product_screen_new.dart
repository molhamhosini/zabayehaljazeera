...
import 'package:zabayeh_aljazeera/view/base/no_data_screen.dart';
import 'package:zabayeh_aljazeera/view/base/product_widget.dart';
import 'package:zabayeh_aljazeera/view/base/web_app_bar/web_app_bar.dart';
import 'package:zabayeh_aljazeera/view/base/web_product_shimmer.dart';
                    ...
                    Container(
                      ...
                      child:  GridView.builder(
                        ...
                        itemBuilder: (context ,index) {
                          return ProductWidget(product: productProvider.categoryProductList[index], isGrid: true);
                        },
                      ),
                      // child: GridView.builder(
                      //   gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
